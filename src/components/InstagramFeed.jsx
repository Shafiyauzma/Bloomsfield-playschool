      ...
      <div className="container">
        <div className="instagram-card-banner">
          <div>
            ...
            >
              @bloomsfieldplayschool <ExternalLink size={20} style={{ display: 'inline', verticalAlign: 'middle' }} />
            </a>
            ...
            <a 
              ...
              style={{ background: '#FFFFFF', color: '#DC2743', fontWeight: 800 }}
            >
              <Instagram size={20} />
          ...
          <div className="insta-posts-preview">
            ...
            >
              <img src="/playschool2.jpeg" alt="Bloomsfield Playschool Instagram Post" className="insta-mini-img" />
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '0.4rem', fontSize: '0.8rem', color: '#FF5E5B', fontWeight: 700 }}>
            ...
            <a 
              ...
              className="insta-mini-card"
            >
              <img src="/art_activity.jpg" alt="Art Activity Instagram Post" className="insta-mini-img" />
              <p className="insta-mini-caption">
                🎨 Little hands, big imagination! Exploring sensory finger art and clay today at Bloomsfield. ❤️ #LearningThroughPlay
              </p>
              <div style={{ display: 'flex', gap: '1rem', marginTop: '0.4rem', fontSize: '0.8rem', color: '#FF5E5B', fontWeight: 700 }}>
                <span>❤️ 154 Likes</span>
